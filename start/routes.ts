...
router
  .group(() => {
    ...
    router.post('/documents/:type/:id/autosave', '#controllers/document_workflows_controller.autosave').as('documents.autosave')
    router.post('/documents/:type/:id/status', '#controllers/document_workflows_controller.status').as('documents.status')
    router.post('/documents/:type/:id/duplicate', '#controllers/document_workflows_controller.duplicate').as('documents.duplicate')
    router
