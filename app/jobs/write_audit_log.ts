...
export default class WriteAuditLog extends Job<AuditLogPayload> {
  static options: JobOptions = { queue: 'audit', maxRetries: 3, timeout: '30s', removeOnComplete: { age: '1h' }, removeOnFail: { age: '1d' } }
  ...
  async execute() {
    await AuditLog.create({
      ...
      entityId: this.payload.entityId == null ? null : String(this.payload.entityId),
