...
export const RPPM_KBC_SEMESTER_1 = [
  ...
  },
  {
    ...
    learningDesign: {
      ...
      digitalUtilization:
        'Penggunaan video edukatif tentang keberagaman, cerita digital interaktif, dan media pembelajaran visual untuk mengenalkan budaya Indonesia. Dukungan media ajar digital tersedia melalui berbagai platform digital',
    },
    openingActivities: [
    ...
    coreDays: [
      {
        ...
        rawContent:
          'HARI 1: MENGENAL SEJARAH KEMERDEKAAN INDONESIA** Penguatan Karakter Utama: BERKEBINEKAAN GLOBAL & KEWARGAANKegiatan Awal (15 menit)Prinsip: Berkesadaran - Membangun kesadaran sejarah bangsa. Pembuka Inspiratif Perjalanan Waktu ke 17 Agustus 1945Guru menyambut anak dengan mengenakan kostum sederhana ala pejuang kemerdekaan. Menciptakan suasana nostalgia dengan musik instrumental lagu nasional. Orientasi bermakna: Hari ini kita akan melakukan perjalanan waktu yang sangat istimewa. Dimensi Profil Lulusan: Berkebinekaan Global (memahami sejarah bangsa), Kewargaan (mengenal identitas nasional)Kegiatan Inti (40 menit)MEMAHAMI (15 menit) Prinsip: Berkesadaran - Memahami peristiwa bersejarah dengan cara menyenangkan. Aktivitas: Time Travel Story Proklamasi Kemerdekaan. Guru bercerita interaktif tentang proklamasi kemerdekaan menggunakan alat peraga sederhana. Anak-anak diajak bermain peran sebagai rakyat yang mendengar proklamasi. Pengenalan tokoh Soekarno-Hatta dengan cara yang mudah dipahami anak. Dimensi Profil Lulusan: Berkebinekaan Global (memahami sejarah bangsa), Bernalar Kritis (memahami sebab-akibat), Komunikasi (mendengarkan cerita aktif)MENGAPLIKASI (15 menit) Prinsip: Bermakna - Menghubungkan sejarah dengan pengalaman konkret. Aktivitas: Dramatic Play Detik-Detik Proklamasi. Anak dibagi kelompok untuk memerankan moment proklamasi sederhana. Menggunakan properti sederhana: bendera kecil, mikrofon mainan, kostum. Setiap kelompok mendapat giliran menjadi Bung Karno yang membacakan proklamasi. Dimensi Profil Lulusan: Kreatif (interpretasi drama sejarah), Bergotong Royong (kerjasama dalam drama), Kewargaan (menghayati moment bersejarah)MEREFLEKSI (10 menit) Prinsip: Menggembirakan - Mengekspresikan perasaan bangga. Aktivitas: Pride Expression Perasaan Merdeka. Anak menggambar ekspresi wajah mereka saat mendengar cerita kemerdekaan. Berbagi perasaan: Bagaimana rasanya kalau kita hidup di zaman penjajahan vs zaman merdeka?Dimensi Profil Lulusan: Mandiri (mengekspresikan perasaan personal), Komunikasi (berbagi emosi), Kreatif (ekspresi visual)Kegiatan Penutup (5 menit)Prinsip: Menggembirakan - Menumbuhkan semangat patriotisme. Menyanyikan lagu Hari Merdeka dengan gerakan sederhana. Preview esok: Besok kita akan menjadi detektif simbol-simbol negara kita!Doa syukur atas kemerdekaan yang dimiliki Indonesia. Dimensi Profil Lulusan: Beriman Bertakwa (bersyukur atas kemerdekaan), Kewargaan (ekspresi nasionalisme), Bergotong Royong (bernyanyi bersama)',
        activities: [
          {
            activityNumber: 1,
            title: 'Kegiatan 1',
    ...
    iktpItems: [
      {
        no: 1,
        indicator:
          'HARI 1 (Sejarah Kemerdekaan): Menyebutkan tanggal 17 Agustus 1945, mengenali tokoh Soekarno-Hatta, antusias dalam dramatic play proklamasi, dan mengekspresikan rasa bangga',
      },
      {
        no: 2,
        indicator:
          'HARI 2 (Simbol Negara): Mengenali makna warna merah putih, bersikap hormat saat upacara bendera, menyanyikan lagu Indonesia Raya, dan mendesain bendera impian',
      },
      {
        no: 3,
        indicator:
          'HARI 3 (Seni Patriotik): Mengapresiasi karya seni kemerdekaan, bekerja sama membuat lampion/janur, dan menghasilkan karya seni bertema patriotik',
      },
      {
        no: 4,
        indicator:
          'HARI 4 (Permainan Tradisional): Memahami nilai budaya permainan tradisional, aktif dalam lomba, menunjukkan sportivitas, dan melestarikan permainan tradisional',
      },
      {
        no: 5,
        indicator:
          'HARI 5 (Parade Budaya): Mengenal keragaman budaya daerah, mempresentasikan pakaian adat dengan percaya diri, dan mengekspresikan persatuan dalam keragaman',
      },
      {
        no: 6,
        indicator:
          'HARI 6 (Upacara & Refleksi): Melaksanakan upacara kemerdekaan dengan sikap hormat, aktif dalam pembacaan proklamasi, dan merefleksikan makna patriotisme',
      },
    ],
    assessmentSteps: {
      initial: [],
        ...
        activities: [
          {
            ...
            howToPlay:
              'dan Memainkannya: Siapkan printable huruf sesuai nama anak-anak. Siapkan printable huruf yang sudah di potong-potong, lalu letakkan di atas lantai. Mintalah anak-anak untuk mencari huruf dan menyusunnya membentuk Namanya sendiri. Kemudian oleskan lem dan rekatkan pada kardus.',
            fullDescription:
              'Kegiatan 1: Mencari dan Menyusun Huruf Membentuk Kata Rumah Ku (Komunikasi, Kemandirian). Alat dan Bahan, printable huruf (setiap huruf di buat lebih dari satu), Kertas karton/ kardus bekas, Lem, Cara Membuat dan Memainkannya: Siapkan printable huruf sesuai nama anak-anak. Siapkan printable huruf yang sudah di potong-potong, lalu letakkan di atas lantai. Mintalah anak-anak untuk mencari huruf dan menyusunnya membentuk Namanya sendiri. Kemudian oleskan lem dan rekatkan pada kardus.',
          },
          {
            activityNumber: 2,
        ...
        activities: [
          {
            ...
            howToPlay:
              'dan memainkannya;Siapkan printable gambar lingkaran berwarna (untuk gambar dapat di sesuaikan. Kemudian, buat ketentuan : Jika lingkaran berwarna kuning maka harus di beri t tegak lurus (vertikal) (I) menggunakan spidol. Jika lingkaran berwarna merah maka harus di beri t silang (X) menggunakan spidol. Jika lingkaran berwarna biru maka harus di beri t strip (-) menggunakan spidol. Jika lingkaran berwarna hijau maka harus di beri t plus (+) menggunakan spidolAnak-anak harus mencoret warna sesuai dengan petunjuk atau ketentuan',
            fullDescription:
              'Kegiatan 1: Coding Warna. Alat dan Bahan (Penalaran Kritis, Kemandirian): printable gambar lingkaran berwarna, Spidol, Cara Membuat dan memainkannya;Siapkan printable gambar lingkaran berwarna (untuk gambar dapat di sesuaikan. Kemudian, buat ketentuan : Jika lingkaran berwarna kuning maka harus di beri t tegak lurus (vertikal) (I) menggunakan spidol. Jika lingkaran berwarna merah maka harus di beri t silang (X) menggunakan spidol. Jika lingkaran berwarna biru maka harus di beri t strip (-) menggunakan spidol. Jika lingkaran berwarna hijau maka harus di beri t plus (+) menggunakan spidolAnak-anak harus mencoret warna sesuai dengan petunjuk atau ketentuan',
          },
          {
  ...
  },
  {
    ...
    learningDesign: {
      ...
      digitalUtilization:
        'Platform pembelajaran daring untuk video cerita, aplikasi sederhana untuk mengenal suara hewan, dan dokumentasi digital hasil karya anak. Dukungan media ajar digital tersedia melalui berbagai platform digital',
    },
    openingActivities: [
      'Salam dan doa pembuka dengan penuh kesadaran',
        ...
        activities: [
          {
            ...
            howToPlay:
              'Mari kita mulai kerajinan ini dengan memotong lingkaran dari lembaran berwarna hijau. Lipat lingkaran menjadi seperempat dan oleskan selotip dua sisi di bagian belakang kuartal. Buat beberapa perempat lagi seperti itu dari kertas lembaran hijau dan oleskan delotip dua sisi pada masing-masing. Tempelkan semua perempat lingkaran dengan pita dua sisi. Gulung kertas lembaran hijau menjadi tongkat dan tempel ujungnya menggunakan selotip dua sisi. Tempelkan selotip dua sisi pada satu sisi perempat lingkaran dengan menekannya sekali. Tempelkan perempat pada tongkat dengan selotip. Lem atau beri selotip pada sisa lingkaran yang saling bertemu. Potong sedikit pegangan paying bagian atas, dan tekuk seperti membentuk huruf J untuk pegangan. Terakhir buat mata katak, dan payu sudah jadi.',
            fullDescription:
              'Kegiatan 1: STEAM Membuat Payung Bentuk Katak Dari Kertas (Kreativitas, Kemandirian). Alat dan bahan: Kertas hijau dan putih, pensil, selotip dua sisi, Gunting. Cara Membuat: Mari kita mulai kerajinan ini dengan memotong lingkaran dari lembaran berwarna hijau. Lipat lingkaran menjadi seperempat dan oleskan selotip dua sisi di bagian belakang kuartal. Buat beberapa perempat lagi seperti itu dari kertas lembaran hijau dan oleskan delotip dua sisi pada masing-masing. Tempelkan semua perempat lingkaran dengan pita dua sisi. Gulung kertas lembaran hijau menjadi tongkat dan tempel ujungnya menggunakan selotip dua sisi. Tempelkan selotip dua sisi pada satu sisi perempat lingkaran dengan menekannya sekali. Tempelkan perempat pada tongkat dengan selotip. Lem atau beri selotip pada sisa lingkaran yang saling bertemu. Potong sedikit pegangan paying bagian atas, dan tekuk seperti membentuk huruf J untuk pegangan. Terakhir buat mata katak, dan payu sudah jadi.',
          },
          {
  ...
  },
  {
    ...
    learningDesign: {
      ...
      digitalUtilization:
        'Penggunaan video edukatif tentang binatang air untuk pengenalan konsep, penggunaan media digital untuk menunjukkan habitat binatang air, dan dokumentasi digital untuk portofolio anak. Teknologi digunakan sebagai alat bantu pembelajaran yang mendukung pengalaman langsung anak. Dukungan media ajar digital tersedia melalui berbagai platform digital',
    },
    openingActivities: [
        ...
        activities: [
          {
            ...
            toolsAndMaterials:
              'Piring kertas, Printable ambar hiu atau binatang lainnya, kertas warna dengan berbagai warna, Mata Googly, stik es krim, Lem, Spidol, Pensil, Gunting',
            howToPlay:
              'Gunting printable gambar hiu, kemudian rekatkan pada stik es krim. Buat pola sepeti gelombang ait di atas kertas biru, kemudian gunting membentuk lingkaran di sesuiakan dengan ukuran bagian bawah piring kertas. Gunakan gunting untuk memotong celah panjang di tepi bawah bagian tengah pelat kertas. Selanjutnya, gunting kertas yang sudah di buat pola gelombang, lalu rekatkan pada piring kertas. Rekatkan tanaman laut di bawah air. Tambahkan item tambahan hiasan seperti rumput laut, bintang laut, ikan kecil, batu, dll. Masukkan stik es krim paa bagian piring yang sudah di potong, hiaupun dapat berenang.',
            fullDescription:
              'Kegiatan 1: STEAM Membuat Kerajinan Hiu Piring Kertas Bergerak (Kreativitas, Penalaran Kritis). Alat dan Bahan: Piring kertas, Printable ambar hiu atau binatang lainnya, kertas warna dengan berbagai warna, Mata Googly, stik es krim, Lem, Spidol, Pensil, Gunting. Cara Membuat: Gunting printable gambar hiu, kemudian rekatkan pada stik es krim. Buat pola sepeti gelombang ait di atas kertas biru, kemudian gunting membentuk lingkaran di sesuiakan dengan ukuran bagian bawah piring kertas. Gunakan gunting untuk memotong celah panjang di tepi bawah bagian tengah pelat kertas. Selanjutnya, gunting kertas yang sudah di buat pola gelombang, lalu rekatkan pada piring kertas. Rekatkan tanaman laut di bawah air. Tambahkan item tambahan hiasan seperti rumput laut, bintang laut, ikan kecil, batu, dll. Masukkan stik es krim paa bagian piring yang sudah di potong, hiaupun dapat berenang.',
          },
          {
  ...
  },
  {
    ...
    learningDesign: {
      ...
      tp: 'Anak mampu menerapkan cara merawat lingkungan alam sekitar. Anak mampu menunjukkan rasa sayang terhadap makhluk hidup di sekitarnya. Anak mampu menggunakan teknologi sederhana untuk menyelesaikan tugas dan kegiatan. Anak mampu membuat alat teknologi sederhana',
      pedagogicalPractice:
  ...
  },
  {
    ...
    learningDesign: {
      ...
      digitalUtilization:
        'Platform pembelajaran digital untuk video edukatif tentang makanan sehat, aplikasi sederhana untuk mengenal jenis-jenis makanan, dan dokumentasi digital kegiatan anak. Dukungan media ajar digital tersedia melalui berbagai platform digital',
    },
    openingActivities: [
    ...
    coreDays: [
      ...
      },
      {
        ...
        phase: 'MENGAPLIKASI (BERMAKNA, MENGGEMBIRAKAN)',
        rawContent:
          'Kegiatan 1: Memindahkan Bola Dengan Satu Tangan (Kesehatan, Kemandirian). Alat dan Bahan: Hula hop, 3 Buah piring (warna merah, hijau, biru atau warna dapat di sesuaikan), Bola plastik (warna yang sama dengan piring). Cara Membuat dan Memainkannya: Siapkan hula hop dan letakkan bola di tengah-tengah hula hop. Letakkan piring di area luar hula hop. Selanjutnya mintalah anak melakukan posisi push-up dan meletakkan bola ke dalam piring yang memiliki warna yang sama menggunakan satu tangan dan tangan satunya untuk menopang tubuh. Kegiatan 2: Eksperimen Air dan Minyak (Penalaran Kritis, Kreativitas). Alat dan Bahan: Gelas transparan, air, minyak sayur, pewarna makanan. Cara Bermain: Anak-anak melakukan eksperimen mencampur air dan minyak, mengamati bahwa keduanya tidak bisa bercampur, dan mendiskusikan pentingnya minum air untuk tubuh. Kegiatan 3: Membuat Menu Seimbang (Kesehatan, Komunikasi). Alat dan bahan: Kertas, pensil warna, contoh menu seimbang. Cara bermain: Anak-anak diminta membuat menu makanan seimbang untuk satu hari dengan menggambar atau menulis. Manfaat: Mengenalkan konsep gizi seimbang dan melatih kreativitas.',
        activities: [
          {
            activityNumber: 1,
            ...
            howToPlay:
              'dan Memainkannya: Siapkan hula hop dan letakkan bola di tengah-tengah hula hop. Letakkan piring di area luar hula hop. Selanjutnya mintalah anak melakukan posisi push-up dan meletakkan bola ke dalam piring yang memiliki warna yang sama menggunakan satu tangan dan tangan satunya untuk menopang tubuh',
            fullDescription:
              'Kegiatan 1: Memindahkan Bola Dengan Satu Tangan (Kesehatan, Kemandirian). Alat dan Bahan: Hula hop, 3 Buah piring (warna merah, hijau, biru atau warna dapat di sesuaikan), Bola plastik (warna yang sama dengan piring). Cara Membuat dan Memainkannya: Siapkan hula hop dan letakkan bola di tengah-tengah hula hop. Letakkan piring di area luar hula hop. Selanjutnya mintalah anak melakukan posisi push-up dan meletakkan bola ke dalam piring yang memiliki warna yang sama menggunakan satu tangan dan tangan satunya untuk menopang tubuh',
          },
          {
            activityNumber: 2,
        ...
        activities: [
          {
            ...
            howToPlay:
              'dan Memainkannya: Siapkan tutup botol bekas, kemudian isi botol dengan pasir untuk pemberat. Rekatkan kertas origami pada tutup botol, lalu tulis angka pada kertas origami yang di rekatkan pada tutup botol. Ajak anak-anak untuk berbaris, dan bergantian menggelindingkan bola agar mengenai tutup botol. Mintalah anak-anak untuk menuliskan angka yang berhasil di jatuhkan pada pasir yang terletak pada nampan atau baki menggunakan jari telunjuk',
            fullDescription:
              'Kegiatan 1: Bowling Angka (Penalaran Kritis, Kolaborasi). Alat dan Bahan :, Botol, Kertas origami, Spidol, Pasir, Lem, Nampan atau baki, Bola, Cara Membuat dan Memainkannya: Siapkan tutup botol bekas, kemudian isi botol dengan pasir untuk pemberat. Rekatkan kertas origami pada tutup botol, lalu tulis angka pada kertas origami yang di rekatkan pada tutup botol. Ajak anak-anak untuk berbaris, dan bergantian menggelindingkan bola agar mengenai tutup botol. Mintalah anak-anak untuk menuliskan angka yang berhasil di jatuhkan pada pasir yang terletak pada nampan atau baki menggunakan jari telunjuk',
          },
          {
  ...
  },
  {
    ...
    learningDesign: {
      ...
      digitalUtilization:
        'Penggunaan video edukasi tentang siklus air, aplikasi sederhana untuk mengenal manfaat air, dokumentasi kegiatan melalui foto dan video, serta media audio untuk lagu-lagu tentang air. Dukungan media ajar digital tersedia',
    },
    openingActivities: [
      'Salam dan doa pembuka dengan penuh kesadaran',
  ...
  },
  {
    ...
    learningDesign: {
      ...
      digitalUtilization:
        'Video edukatif tentang manfaat dan bahaya api, media interaktif untuk pengenalan alat-alat yang menggunakan api, aplikasi sederhana untuk klasifikasi benda, dan dokumentasi digital untuk portofolio anak. Dukungan media ajar digital tersedia melalui berbagai platform digital',
    },
    openingActivities: [
      'Salam dan doa pembuka',
        ...
        activities: [
          {
            ...
            howToPlay:
              'Siapkan dua gelas plastic. Lubangi bagian bawah gelas. Masukkan senar ke dalam lubang kemudian dari dalam ikatkan denan lidi agar senar tidak terlepas, lakukan hal yang sama untuk gelas plastic satunya. Nah telepon mainan sudah siap di gunakan.',
            fullDescription:
...
export default class RppmKbcSemester1Seeder extends BaseSeeder {
  ...
  async run() {
    ...
    const atpItems = seededObjectives.map(({ weekNum, objective }) => {
      const item = RPPM_KBC_SEMESTER_1.find((r) => r.weekNum === weekNum)
      return {
        learningObjectiveId: objective.id,
        order: weekNum,
        period: `Minggu ${weekNum}: ${item?.topic ?? 'Tema'} - ${item?.subtopic ?? 'Subtema'}`,
        unitTopic: getUnitTopic(weekNum),
      }
    })
