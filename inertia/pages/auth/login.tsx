                  ...
                  <div className="flex items-center justify-between py-1">
                    ...
                    >
                      <input
                        type="checkbox"
                        name="remember"
                        className="w-4 h-4 rounded-lg border-2 border-neutral-300 dark:border-neutral-600 text-emerald-600 focus:ring-emerald-500 cursor-pointer"
                      />
