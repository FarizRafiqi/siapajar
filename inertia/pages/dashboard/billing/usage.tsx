...
export default function Usage({ periodLabel, usage }: { periodLabel: string; usage: UsageItem[] }) {
  return (
    <DashboardWrapper
      title="Penggunaan"
      breadcrumbs={[
    ...
    >
      ...
      <div className="space-y-6">
        <div className="flex flex-wrap items-start justify-between gap-3">
          <div>
            <h2 className="text-2xl font-bold text-neutral-900 dark:text-white">Penggunaan</h2>
          ...
          <Link
            href="/my-package"
            className="inline-flex items-center gap-2 rounded-lg border border-neutral-200 px-3 py-2 text-sm text-neutral-700 hover:bg-neutral-50 dark:border-neutral-700 dark:text-neutral-200 dark:hover:bg-neutral-800"
          >
            <ArrowLeft className="h-4 w-4" /> Paket Saya
          </Link>
        </div>
        {usage.length === 0 ? (
