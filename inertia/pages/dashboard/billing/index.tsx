...
const TOPUP_TIERS: TopupTier[] = [
  ...
  },
  {
    ...
    features: [
      '45 Kredit SiapAjar',
      'Hemat 25% dibanding paket reguler',
      'Kredit tidak pernah hangus',
  ...
  },
  {
    ...
    credits: 350,
    price: 249000,
    priceFormatted: 'Rp249.000',
    costPerDoc: 'Rp711 / dokumen',
    discountBadge: 'Hemat 47%',
    description: 'Multi-guru & akreditasi lengkap untuk 1 institusi.',
    features: [
      '350 Kredit SiapAjar',
      'Hemat 47% (Paling ekonomis)',
      'Kredit tidak pernah hangus',
      'Dashboard Supervisi & Multi-User',
