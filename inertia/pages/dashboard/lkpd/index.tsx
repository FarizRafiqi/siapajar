...
import { FileSpreadsheet, Trash2, Eye, Plus } from 'lucide-react'
...
export default function LkpdIndex({ lkpds, classes, sequences }: LkpdIndexProps) {
  ...
  const handleDelete = () => {
    if (!deletingLkpd) return
    router.delete(`/lkpd/${deletingLkpd.id}`, {
      onSuccess: () => setDeletingLkpd(null),
    })
  }
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
          ...
          >
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <select
                  id="ageGroup"
                  value={data.ageGroup}
                  onChange={(e) => setData('ageGroup', e.target.value)}
                  className="w-full rounded-lg border border-neutral-300 px-3 py-2 dark:border-neutral-600 dark:bg-neutral-800 dark:text-white"
                >
                  ...
                  <option value="KB / TPA (2-4 Tahun)">KB / TPA (2-4 Tahun)</option>
                </select>
              </div>
              <div>
                <label
                ...
                <input
                  ...
                  className="w-full rounded-lg border border-neutral-300 px-3 py-2 dark:border-neutral-600 dark:bg-neutral-800 dark:text-white"
                  placeholder="contoh: Aku Hamba Allah / Aku Sayang Bumi"
                />
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-lg border border-neutral-300 px-3 py-2 dark:border-neutral-600 dark:bg-neutral-800 dark:text-white"
                  placeholder="contoh: Anggota Tubuhku Karunia Allah"
                />
              </div>
            </div>
            <div className="mt-6 flex gap-3">
              ...
              >
                {processing ? 'Sedang membuat...' : 'Generate LKPD'}
              </button>
            </div>
          </motion.div>
        </div>
