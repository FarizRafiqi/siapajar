    ...
    <div className={cn('relative overflow-hidden', className)}>
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div
          ...
          style={{
            background:
              'radial-gradient(circle, rgba(16,185,129,0.3) 0%, rgba(5,150,105,0.15) 50%, transparent 70%)',
        ...
        <div
          ...
          style={{
            background:
              'radial-gradient(circle, rgba(16,185,129,0.2) 0%, rgba(16,185,129,0.15) 50%, transparent 70%)',
        ...
        <div
          ...
          style={{
            background:
              'radial-gradient(circle, rgba(52,211,153,0.25) 0%, rgba(16,185,129,0.1) 50%, transparent 70%)',
